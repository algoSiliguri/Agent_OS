...
const FILES = [
  ...
  {
    bundle: '.agent-os/schemas/constitution-binding.schema.json',
    fixture: '.agent-os/schemas/constitution-binding.schema.json',
  },
  {
    bundle: '.agent-os/schemas/telemetry-event.schema.json',
    fixture: '.agent-os/schemas/telemetry-event.schema.json',
  },
  {
    bundle: '.agent-os/schemas/permission-manifest.schema.json',
    fixture: '.agent-os/schemas/permission-manifest.schema.json',
  },
